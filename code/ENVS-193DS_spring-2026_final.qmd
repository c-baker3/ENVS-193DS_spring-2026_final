...
- **Similarities**: All three visualizations use sleep duration or workout type on the x-axis and show some form of individual observations; the jittered open cirlces in the boxplot, the individual points in the scatterplot, and the binary data underlying the logistic curve in the affective visualization. 
