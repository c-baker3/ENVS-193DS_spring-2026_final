...
For a binomial GLM, the assumptions needed to be met are:

- observations are independent 
- the response variable follows a binary distribution (there are binary outcomes)
- there is a linear relationship between transformed expected response in terms of link function and explanatory variables (WHAT DOES THIS MEAN -- REPHRASE)

### Write your model

**In words**: Sleep duration the previous night predicts the occurence of going on a run (yes = 1, no = 0).
